...
import { Link } from "react-router-dom"; // ✅ Fixed this line
    ...
    <div>
      <div className="border border-[#737373] w-[350px] mx-auto mt-3 h-[520px]">
        ...
        <div>
          ...
          <h1 className="text-[14px] text-black font-semibold text-center">
            Add your date of birth
          </h1>
        </div>
        <div>
          <h1 className="text-[14px] text-black font-normal text-center mt-5">
            This won't be part of your public profile.
          </h1>
          <h1 className="text-[14px] text-center text-[#0095F6]">
        ...
        {/* Description */}
        <div>
          <h1 className="text-[12px] text-[#737373] text-center mt-2">
            You need to enter the date you were born on
          </h1>
          <h1 className="text-[12px] text-[#737373] text-center mt-5 w-[292px] mx-auto">
        ...
        <div>
          <Link to="/verification" className="flex justify-center items-center">
            <button className="w-full max-w-[290px] mt-4 h-8 bg-[#53bdeb] text-white text-[15px] font-[600] rounded-lg hover:bg-[#1877F2]">
              Next
            </button>
          </Link>
        </div>
        ...
        <div>
          <Link
            to="/signup"
            className="text-[14px] flex justify-center items-center mt-3 text-[#0095F6] font-semibold"
          >
            Go back
          </Link>
        </div>
