        ...
        <div>
            ...
            <div className='w-full h-full flex mt-24 justify-evenly'>
                ...
                <div className='h-full hidden md:block'>
                    <img src="src/assets/Images/FirstPageImage.png" alt="image" className='h-[450px] object-cover' />
                </div>
                {/* Login div */}
                <div className="lg:mr-12">
                    <div>
                        <img src='src/assets/Images/InstagramFont.png' alt='' className='w-44 block mx-auto' />
                    </div>
                    ...
                    <div>
                        {/* Button */}
                        <Link to="/">  
                        <button className='w-full max-w-[300px]   mt-4 h-8 bg-[#53bdeb] text-white text-[15px] font-[600] rounded-xl hover:bg-[#1877F2]'> Log in</button></Link>
                    ...
                    <div className='flex justify-center items-center gap-2 mt-4 text-[#0095F6]'>
                        <div>
                            {/* Facbook image */}
                            <img src="src/assets/Images/Facebook.png" alt="Facebook Logo" className='w-6 h-6 inline-block ' />
                        </div>
                        <div>
                            <h1 className='font-semibold text-[14px] hover:text-blue-900'>Log in with Facebook</h1>
                        </div>
                    </div>
                    {/* Forget Password */}
                    <h1 className='text-center ml-8 mt-5 text-[#00376B]'>Forgotten your password?</h1>
                    {/* SignUp div */}
                    <div className='flex gap-1 justify-center items-center mt-8'>
                        <h1 className='text-center text-[15px] font-normal'>Don't have an account?</h1>
                        <Link to="/signup" className='text-[#0095F6] font-semibold'>Sign Up</Link>
                    </div>
                    {/* Get app */}
                    <div>
