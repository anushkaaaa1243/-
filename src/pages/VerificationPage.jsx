  ...
  return (
    <div>
      <div className="border boder-[#737373] w-[350px]  mx-auto  mt-3 h-[380px]">
        ...
        <div>
          <img
            src="src/assets/Images/verificationEmail.jpg"
            alt="verification"
        ...
        <div className="mx-auto mt-5 flex justify-center items-center gap-4">
          <input type="text" placeholder="Confirmation code" className="w-[268px] h-[40px] border-[1.9px]  border-[#737373] px-2 rounded-md bg-[#FAFAFA] outline-none text-[14px] font-medim"/>
        </div>
        {/* Button */}
        <div>
          <Link to="/">     
          ...
          <Link to="/signup" className="flex justify-center items-center mt-4 text-[#0095F6] font-semibold text-[14px]">Go back</Link>
        </div>
      </div>
      <div className='md:border md:boder-[#737373] w-[350px] mx-auto  mt-3 h-20'>
                <div className=' gap-1 mt-5 '>
                    ...
                    <Link to="/login" className='flex items-center justify-center text-[#0095F6] font-semibold text-[14px]'>Log in</Link>
